...
local function trim_spell_name(string_spell_name)
	...
	string_spell_name = string_spell_name:gsub('ACG', '')
	string_spell_name = string_spell_name:gsub('APG', '')
	string_spell_name = string_spell_name:gsub('ARG', '')
	string_spell_name = string_spell_name:gsub('HA', '')
	string_spell_name = string_spell_name:gsub('ISWG', '')
	string_spell_name = string_spell_name:gsub('MA', '')
	string_spell_name = string_spell_name:gsub('MC', '')
	string_spell_name = string_spell_name:gsub('OA', '')
	string_spell_name = string_spell_name:gsub('UC', '')
	string_spell_name = string_spell_name:gsub('UI', '')
	string_spell_name = string_spell_name:gsub('UM', '')
	string_spell_name = string_spell_name:gsub('UW', '')
